const todo =[
  ...
  //TODO { icon: { name: 'vue' }, ids: ['vue', 'vue-postcss', 'vue-html'] },
  //TODO { icon: { name: 'yaml' }, ids: ['yaml'] },
  //TODO { icon: { name: 'settings' }, ids: ['makefile', 'toml', 'ini', 'properties'] },
  //TODO { icon: { name: 'sass' }, ids: ['sass', 'scss'] },
  //TODO { icon: { name: 'less' }, ids: ['less'] },
  //TODO { icon: { name: 'css' }, ids: ['css'] },
  //TODO { icon: { name: 'docker' }, ids: ['dockerfile'] },
  //TODO { icon: { name: 'postcss' }, ids: ['postcss'] },
  //TODO { icon: { name: 'haskell' }, ids: ['haskell'] },
  //TODO { icon: { name: 'php' }, ids: ['php'] },
  //TODO { icon: { name: 'csharp' }, ids: ['csharp'] },
  //TODO { icon: { name: 'batch' }, ids: ['bat'] },
  //TODO { icon: { name: 'shell' }, ids: ['awk', 'shellscript'] },
  //TODO { icon: { name: 'cpp' }, ids: ['cpp'] },
  //TODO { icon: { name: 'editorconfig' }, ids: ['editorconfig'] },
  //TODO { icon: { name: 'markdown' }, ids: ['markdown'] },
  //TODO { icon: { name: 'document' }, ids: ['plaintext'] },
  //TODO { icon: { name: 'pdf' }, ids: ['pdf'] },
  //TODO { icon: { name: 'powershell' }, ids: ['powershell'] },
  //TODO { icon: { name: 'svg' }, ids: ['svg'] },
  //TODO { icon: { name: 'vlang' }, ids: ['v'] },
  //TODO { icon: { name: 'python' }, ids: ['python'] },
  //TODO { icon: { name: 'java' }, ids: ['java'] },
  //TODO { icon: { name: 'c' }, ids: ['c', 'objective-c', 'objective-cpp'] },
  //TODO { icon: { name: 'xml' }, ids: ['xml', 'xquery', 'xsl'] },
